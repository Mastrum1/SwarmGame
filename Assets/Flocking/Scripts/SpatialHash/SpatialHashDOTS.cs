...
public class SpatialHashDOTS : SpatialHash
{
    ...
    private struct BlittableBoidCell
    {
        ...
        public BlittableBoidCell(GameObject obj)
        {
            ...
            boids.Add(new Boid_Blittable(obj.transform.position, obj.GetComponent<Rigidbody>().linearVelocity));
        }
        ...
        */
        ...
        {
            return new Boid_Blittable(obj.transform.position, obj.GetComponent<Rigidbody>().linearVelocity);
        }
